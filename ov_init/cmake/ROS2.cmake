...
add_library(ov_init_wheel_lib SHARED ${LIBRARY_SOURCES} ${LIBRARY_HEADERS})
ament_target_dependencies(ov_init_wheel_lib rclcpp ov_core_wheel cv_bridge)
target_link_libraries(ov_init_wheel_lib ${thirdparty_libraries})
target_include_directories(ov_init_wheel_lib PUBLIC src/)
install(TARGETS ov_init_wheel_lib
...
ament_export_libraries(ov_init_wheel_lib)
...
target_link_libraries(test_simulation ov_init_wheel_lib ${thirdparty_libraries})
...
target_link_libraries(test_dynamic_mle ov_init_wheel_lib ${thirdparty_libraries})
...
target_link_libraries(test_dynamic_init ov_init_wheel_lib ${thirdparty_libraries})
